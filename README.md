...
index.html can be opened directly to view the webpage locally, but most be hosted to be seen on other devices (on or off your network)
...
2. Run shiftingtiles/updateimages.json.ps1 to generate a new version of index.html with a current list of images.
